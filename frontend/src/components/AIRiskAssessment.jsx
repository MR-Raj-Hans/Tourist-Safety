...
import { FiBrain, FiTrendingUp, FiTrendingDown, FiShield, FiAlertTriangle, FiActivity, FiZap, FiTarget } from 'react-icons/fi';
  ...
  const BrainVisualization = () => (
    <div className="relative w-24 h-24 mx-auto mb-4">
      ...
      <div className="absolute inset-4 rounded-full bg-gradient-to-r from-purple-400 to-blue-400 flex items-center justify-center">
        <FiBrain className="w-8 h-8 text-white animate-pulse" />
      </div>
