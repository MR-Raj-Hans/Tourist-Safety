...
import { FiAlertTriangle, FiPhone, FiMapPin, FiClock, FiShield } from 'react-icons/fi';
...
const EmergencyAlerts = () => {
  ...
  const emergencyContacts = [
    { name: 'Emergency Services', number: '911', type: 'emergency', icon: FiAlertTriangle },
    { name: 'Tourist Police', number: '+1-800-TOURIST', type: 'police', icon: FiShield },
    { name: 'Medical Emergency', number: '+1-800-MEDICAL', type: 'medical', icon: FiPhone },
    { name: 'Embassy Contact', number: '+1-800-EMBASSY', type: 'embassy', icon: FiMapPin }
  ];
